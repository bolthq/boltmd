...
- [ ] P13-8: 侧栏文档结构面板组件（根据 Markdown 标题 H1-H6 自动生成树形结构）
- [ ] P13-9: 点击标题节点快速跳转到对应位置（WYSIWYG + Source 两种模式都支持）
- [ ] P13-10: 高亮当前所在章节（滚动时实时更新）
- [ ] P13-11: 树节点可折叠/展开（按标题层级嵌套）
- [ ] P13-12: 面板可显示/隐藏（快捷键 + 设置）+ 宽度可拖拽
- [ ] P13-13: 编辑内容变化时结构树实时更新（防抖 300ms）
- [ ] P13-14: Ctrl+Shift+O 快速跳转面板（类似命令面板，模糊搜索标题，回车跳转）
- [ ] P13-15: 面包屑导航（状态栏显示当前所在标题路径 H1 > H2 > H3）

...
const officialPlugins: OfficialPlugin[] = [
  {
    id: 'webdav-sync',
    name: 'WebDAV Sync',
    description: 'Cloud file sync via WebDAV protocol. Supports self-hosted, Nutstore, NextCloud, and NAS.',
    author: 'BoltMD',
    status: 'coming-soon',
  },
  {
    ...
    description: 'AI-powered writing tools: polish, translate, continue, summarize. Multi-LLM backend support.',
    author: 'BoltMD',
    status: 'coming-soon',
  },
  {
    id: 'mdz-format',
    name: '.mdz Package Format',
    description: 'Bundle markdown and images into a single .mdz file for portable sharing.',
    author: 'BoltMD',
    status: 'coming-soon',
  },
]
